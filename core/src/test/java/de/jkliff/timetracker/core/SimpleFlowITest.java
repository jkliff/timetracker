...
public class SimpleFlowITest {
    ...
    public void testSimpleFlow()
        ...
        try {
            ...
            Activity a1 = ActivityBuilder.forGroup("default").startedAt("2011-10-10 13:00").finishedAt("2011-10-10 14:00").named(A1_NAME)
            ...
            List<ActivitySummary> activitySummaries = activityService.list(QueryBuilder.findActivitySummaries().taggedWith("work").build());
            ...
            activitySummaries = activityService.list(QueryBuilder.findActivitySummaries().shorterThan("30 min").taggedWith("work").build());
            Assert.assertNotNull(activitySummaries);
            Assert.assertEquals(9, activitySummaries.size());
