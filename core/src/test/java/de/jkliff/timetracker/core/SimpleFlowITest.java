	...
	public void saveTestData() throws ParseException {
		...
		Activity[] activities = new Activity[] {
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 13:00")
						.finishedAt("2011-10-10 13:30").named("tomando banho")
						.withTags("test").build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 13:30")
						.finishedAt("2011-10-10 13:35")
						.named("escovando os dentes").withTags("test").build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 14:00")
						.finishedAt("2011-10-10 14:20")
						.named("indo para o trabalho").withTags("test").build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 14:30")
						.finishedAt("2011-10-10 15:00").named("almoço")
						.withTags("test").build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 15:00")
						.finishedAt("2011-10-10 15:05")
						.named("escovando os dentes novamente")
						.withTags("test").build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-10 16:00")
						.finishedAt("2011-10-11 17:00")
						.named("viagem intercontinental").withTags("test")
						.build(),
				ActivityBuilder.forGroup("default")
						.startedAt("2011-10-12 09:00")
						.finishedAt("2011-10-12 14:00").named("estudando")
