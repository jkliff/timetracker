...
public class AbstractSummaryDAOImpl<T extends SummaryEntity> extends AbstractRawDAO {
    ...
    public List<T> find(final String hql, RowMapper<T> mapper) {
        Query query = getEntityManager().createQuery(hql);
        return query.getResultList();
    }

    public List<T> find(final Pair<String, Map<String, Object>> hqlWithParams, RowMapper<T> mapper) {
    ...
    private List<T> mapSummaryRows(List<Object[]> resultList, RowMapper<T> mapper) {
